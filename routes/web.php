...
Route::middleware(['auth'])->group(function () {
   ...
   Route::middleware((['role:admin']))->group(function () {
      ...
      Route::view('absensi-kerja', 'pages.absensi_kerja.index');
      Route::get('absensi-kerja/getData', [AbsensiKerjaController::class, 'getData']);
      Route::post('absensi-kerja/store', [AbsensiKerjaController::class, 'store']);
      Route::post('absensi-kerja/update', [AbsensiKerjaController::class, 'update']);
      Route::post('absensi-kerja/updateStatus', [AbsensiKerjaController::class, 'updateStatus']);
      Route::post('absensi-kerja/destroy', [AbsensiKerjaController::class, 'destroy']);
      Route::post('absensi-kerja/selesai', [AbsensiKerjaController::class, 'selesai']);
      Route::get('absensi-kerja/export', [AbsensiKerjaController::class, 'export']);
